<header class="header header-sticky p-0 mb-4">
    <div class="container-fluid border-bottom px-4">
        ...
        <ul class="header-nav d-none d-lg-flex list-unstyled mb-0">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('delivery.profile') }}">Profile</a>
            </li>
        </ul>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link py-0 pe-0 d-flex align-items-center" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
                    <div class="avatar avatar-md">
                        <img class="avatar-img rounded-circle" src="https://ui-avatars.com/api/?name={{ auth('delivery')->user()->name ?? 'Delivery' }}&background=16a34a&color=fff" alt="{{ auth('delivery')->user()->name ?? 'Delivery' }}">
                    </div>
                    <span class="ms-2 d-none d-md-inline">{{ auth('delivery')->user()->name ?? 'Delivery Staff' }}</span>
                </a>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 py-2">
                <li class="breadcrumb-item">
                    <a href="{{ route('delivery.dashboard') }}">Home</a>
                </li>
